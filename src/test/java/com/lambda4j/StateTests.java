...
public class StateTests {
    ...
    public void unit_works() {
        ...
        RNG rng = new JavaRNG(42);
        StateTuple<Integer, RNG> result = state.run.apply(rng);
    ...
    public void map2_works() {
        ...
        StateTuple<Integer, RNG> result = state3.run.apply(rng);
    ...
    public void sequence_works() {
        ...
        StateTuple<List<Integer>, RNG> tuple = state.run.apply(rng);

        assertEquals(2, tuple.value.lengthMemoized());
        assertEquals(1, tuple.value.head());
    }
    ...
    public void set_works() {
        ...
        assertEquals(1, newState.run.apply(rng).value);
    }
}
